    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkNpgsql().AddDbContext<DndContext>
                (options => options.UseNpgsql(connection).UseLazyLoadingProxies());

            var key = Configuration.GetSection("MyConfig").GetSection("Key").Value;

            services.AddIdentityCore<DndUser>()
